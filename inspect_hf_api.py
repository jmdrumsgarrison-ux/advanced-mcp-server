...
def inspect_hf_api():
    ...
    try:
        ...
        with open("hf_api_inspection_results.json", "w") as f:
            json.dump({
        ...
        print(f"✅ Complete inspection saved to: hf_api_inspection_results.json")
        ...
        print(f"❌ HuggingFace Hub not available: {e}")
        return []
    except Exception as e:
...
if __name__ == "__main__":
    ...
    print(f"\n🎉 HuggingFace Hub API Inspection Complete!")
